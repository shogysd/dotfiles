...
echo "download git completion" ; rm -f ~/dotfiles/git/git-completion.bash ; ${MY_DOWNLOAD_COMMAND} ~/dotfiles/git/git-completion.bash https://raw.githubusercontent.com/git/git/d9f6f3b6195a0ca35642561e530798ad1469bd41/contrib/completion/git-completion.bash
